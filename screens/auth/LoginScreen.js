...
import { ref, child, get, set, update, getDatabase } from "firebase/database";
      ...
      >
        <ScrollView style={{ flex: 1, width: "100%" }}>
          ...
          <View style={styles.welconeContainer}>
            <View>
              <Text style={styles.welcomeText}>Welcome to MeowCare</Text>
              <Text style={styles.welcomeParagraph}>
                make your easier to watch your pet
              </Text>
            </View>
            <View>
